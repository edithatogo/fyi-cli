...
This packet is prepared for the documented Codex plugin submission route. It is
not evidence that a submission has been filed or accepted. The public status
...
3. Submit through the approved Codex route using the maintainer account.
