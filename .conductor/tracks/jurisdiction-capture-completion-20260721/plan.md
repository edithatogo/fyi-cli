...
- [x] Foundation capture audit and archive handoff.
  - [x] Record a versioned foundation handoff manifest that consolidates every
    bounded jurisdiction audit, archive readiness state and external blocker.
    (`foundation_capture_handoff_manifest.json`)
...
- [x] UK and European English increments.
...
- [x] At each increment, stop before live capture without operator authorization and record archive/NLP/process dependencies.
  - [x] The foundation handoff manifest records archive, NLP and process
    dependencies across all bounded jurisdiction audits.
