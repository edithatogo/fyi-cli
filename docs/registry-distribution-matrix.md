...
| Smithery | **live** (score pending) | Registry: `edithatogo/fyi-mcp`; page [smithery.ai/server/@edithatogo/fyi-mcp](https://smithery.ai/server/@edithatogo/fyi-mcp); **score still `null`** (2026-07-09). Repo: `smithery.yaml` + initialize instructions + prompts. Operator rescan: [docs/external-registry-followups.md](external-registry-followups.md) | #26 |
| GitHub curated MCP surface (`github.com/mcp`) | **blocked-external** | OSS registry has `io.github.edithatogo/fyi-mcp@0.1.2`; curated surface still 404 / no card. Onboarding is manual (see [discussion #1257](https://github.com/github/github-mcp-server/discussions/1257)). Playbook: [docs/external-registry-followups.md](external-registry-followups.md) | #32 |
