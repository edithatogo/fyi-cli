...
# Fixed: Email regex now handles edge cases like {*@A.AC and 0*@A.aD
# Local part can start with any character except @ and whitespace
# Must have exactly one @ and a valid domain with at least one dot
